...
def data():
    ...
    functional = functional.rename(columns={"subject": "Sample", "IFNy": "IFNγ", "MIP1b": "MIP1β"})
    functional = pd.melt(functional, id_vars=['Sample'], var_name='Function', value_name='Functional')
    df["Functional"] = functional.set_index(["Sample", "Function"]).to_xarray()["Functional"]
    return df
